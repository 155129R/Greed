...
{   
	...
	g_abKeyPressed[K_HIGHSCORE]		= isKeyPressed('N');
}
...
void update(double dt)
{
    ...
    switch (g_eGameState)
    {
        ...
        case S_GAME: gameplay(); // gameplay logic when we are in the game
            break;
			case S_HIGHSCORE:{check(total1,total2);
				write();}
							 break;
...
void render()
{
    ...
    switch (g_eGameState)
    {
        ...
        case S_GAME: renderGame();
            break;
		case S_HIGHSCORE:  AskforInput();print();		
			break;
    }
...
void renderSplashScreen()  // renders the splash screen
{
    ...
    g_Console.writeToBuffer(c, "Press 'Esc' to quit", 0x09);
		//g_Console.writeToBuffer(c.Y,c.X+1," : ",CheckPlayer1Score, 0x04);
	//	g_Console.writeToBuffer(c.Y,c.X+1," : ",CheckPlayer1Score, 0x04);
}
